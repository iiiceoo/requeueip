...
// Copyright 2024-2026 The RequeueIP Authors.
//
...
func (in *IPPoolClaimStatus) DeepCopyInto(out *IPPoolClaimStatus) {
	*out = *in
	...
	if in.NextScaleDownTime != nil {
		in, out := &in.NextScaleDownTime, &out.NextScaleDownTime
		*out = (*in).DeepCopy()
	}
}
...
func (in *SubnetStatus) DeepCopyInto(out *SubnetStatus) {
	*out = *in
	...
	if in.BlockCount != nil {
		in, out := &in.BlockCount, &out.BlockCount
		*out = new(BlockCount)
		**out = **in
	}
}
